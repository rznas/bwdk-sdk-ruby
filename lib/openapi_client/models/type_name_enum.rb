...
module OpenapiClient
  class TypeNameEnum
    ...
    def self.all_vars
      @all_vars ||= [COLOR, SIZE, WARRANTY, WEIGHT, OTHER].freeze
    end
    ...
    def build_from_hash(value)
      return value if TypeNameEnum.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #TypeNameEnum"
    end
  end
end
