...
# Unit tests for OpenapiClient::MerchantPaidOrderList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MerchantPaidOrderList do
  #let(:instance) { OpenapiClient::MerchantPaidOrderList.new }

  describe 'test an instance of MerchantPaidOrderList' do
    it 'should create an instance of MerchantPaidOrderList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MerchantPaidOrderList)
    end
  end
  ...
  describe 'test attribute "refunds_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
