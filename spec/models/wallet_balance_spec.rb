...
# Unit tests for OpenapiClient::WalletBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WalletBalance do
  #let(:instance) { OpenapiClient::WalletBalance.new }

  describe 'test an instance of WalletBalance' do
    it 'should create an instance of WalletBalance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WalletBalance)
    end
  end
  ...
  describe 'test attribute "negative_settlement_deadline"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
