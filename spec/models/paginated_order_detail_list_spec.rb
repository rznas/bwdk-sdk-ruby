...
# Unit tests for OpenapiClient::PaginatedOrderDetailList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaginatedOrderDetailList do
  #let(:instance) { OpenapiClient::PaginatedOrderDetailList.new }

  describe 'test an instance of PaginatedOrderDetailList' do
    it 'should create an instance of PaginatedOrderDetailList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PaginatedOrderDetailList)
    end
  end
