...
# Unit tests for OpenapiClient::ReviveShipment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReviveShipment do
  #let(:instance) { OpenapiClient::ReviveShipment.new }

  describe 'test an instance of ReviveShipment' do
    it 'should create an instance of ReviveShipment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReviveShipment)
    end
  end
