...
# Unit tests for OpenapiClient::MerchantOrderRefundResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MerchantOrderRefundResponse do
  #let(:instance) { OpenapiClient::MerchantOrderRefundResponse.new }

  describe 'test an instance of MerchantOrderRefundResponse' do
    it 'should create an instance of MerchantOrderRefundResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MerchantOrderRefundResponse)
    end
  end
