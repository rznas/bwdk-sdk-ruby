...
# Unit tests for OpenapiClient::PaginatedMerchantPaidOrderListList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaginatedMerchantPaidOrderListList do
  #let(:instance) { OpenapiClient::PaginatedMerchantPaidOrderListList.new }

  describe 'test an instance of PaginatedMerchantPaidOrderListList' do
    it 'should create an instance of PaginatedMerchantPaidOrderListList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PaginatedMerchantPaidOrderListList)
    end
  end
