...
# Unit tests for OpenapiClient::MerchantOrderCancelShipmentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MerchantOrderCancelShipmentResponse do
  #let(:instance) { OpenapiClient::MerchantOrderCancelShipmentResponse.new }

  describe 'test an instance of MerchantOrderCancelShipmentResponse' do
    it 'should create an instance of MerchantOrderCancelShipmentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MerchantOrderCancelShipmentResponse)
    end
  end
